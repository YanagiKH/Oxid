...
These scripts run the Oxid tool previews directly from the repository and are the quickest path for users who clone the project and start writing Oxid code immediately.
